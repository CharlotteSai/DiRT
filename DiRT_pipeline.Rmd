...
```{r}
seq.size <- BamFile("~/biohub/RNAseq_terroir/2_HISAT2/20.bothrun.sorted.cleaned.bam") %>% 
  seqinfo() %>% 
  as.data.frame() %>% 
...
## Count reads for each tRNA GRange from ```bam``` files 
```{r}
# specify Samples
bam.dir <- "~/biohub/RNAseq_terroir/2_HISAT2" # Dir for bamfiles 
